...
import tum from '../assets/tum_logo.jpg'
            ...
            <div className=' bg-zinc-900'>
                ...
                <div className='space-y-4'>
                    <div className='text-white px-10 flex flex-col space-y-1 pb-6'>
                        ...
                        <EducationElement number="1" title="Technische Universität München" link="https://www.tum.de/" image={tum} description="Wirtschaftsinformatik" description2="Master's degree" timeSpan="Start: Oct 2024" />
                        <EducationElement number="2" title="Faculty of Electrical Engineering Sarajevo" link="https://www.etf.unsa.ba/en/o-nama" image={etf} description="Department for Computer Science and Informatics" description2="Bachelor degree" timeSpan="2020-2023" />
                        <EducationElement number="3" title="Universidad Católica de Valencia" link="https://www.ucv.es/" image={ucv} description="Department for Business" description2="Bachelor degree" timeSpan="2024" />
                        <h1 className="text-2xl font-bold  text-white ml-7 mt-3 pt-10">Internships</h1>
                        <div className='ml-7 text-grayText'>Hover over elements for more details</div>
